                    ...
                    <div class="card border-width-3 border-radius-0 border-color-hover-dark" data-plugin-sticky data-plugin-options="{'minWidth': 991, 'containerSelector': '.row', 'padding': {'top': 85}}">
                        <div class="card-body">
                            ...
                            <table class="shop_table cart-totals mb-3">
                                <tbody>
                                    <ul>
                                        <li colspan="2" class="border-top-0">
                                    ...
                                    <ul>
                                        ...
                                        <li>
                                            @foreach ($cart as $carts)
                                                ...
                                                <strong class="d-block text-color-dark line-height-1 font-weight-semibold">{{$carts->produit->name}}
                                                 <span class="product-qty"> = {{$carts->quantite}}</span>
                                            </strong>
                                        
                                        </li>
                                        <li class="text-end align-top">
                                            <span class="amount font-weight-medium text-color-grey">{{$carts->price * $carts->quantite}}€</span>
                                            @endforeach
                                        </li>
